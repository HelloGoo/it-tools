import{ac as We,ct as qe,cu as Ge,ai as D,af as n,aj as b,ag as j,bV as he,bh as Je,bi as Qe,d as Ze,al as eo,am as ge,p as k,b as w,an as oo,ao,V as fe,aU as Z,a5 as to,ap as ve,bX as no,bY as ee,ar as f,b_ as ro,b$ as lo,aS as io,c0 as so,aH as co,av as N,aR as U,b4 as O}from"./index-2e588a01.js";import{u as uo}from"./use-form-item-6311a236.js";const ho=t=>{const l="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:v,primaryColor:s,baseColor:d,cardColor:z,modalColor:R,popoverColor:L,borderRadius:X,fontSize:M,opacityDisabled:B}=t;return Object.assign(Object.assign({},qe),{fontSize:M,markFontSize:M,railColor:v,railColorHover:v,fillColor:s,fillColorHover:s,opacityDisabled:B,handleColor:"#FFF",dotColor:z,dotColorModal:R,dotColorPopover:L,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:l,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:X,dotBorder:`2px solid ${v}`,dotBorderActive:`2px solid ${s}`,dotBoxShadow:""})},fo={name:"Slider",common:We,self:ho},vo=fo;function be(t){return window.TouchEvent&&t instanceof window.TouchEvent}function me(){const t=new Map,l=y=>v=>{t.set(y,v)};return Ge(()=>{t.clear()}),[t,l]}const bo=D([n("slider",`
 display: block;
